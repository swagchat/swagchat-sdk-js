...
var Room = (function () {
    ...
    Room.prototype.subscribeMessage = function (onMessageReceived) {
        ...
        if (!this._client.connection) {
            _1.logger("realtime", "error", "Subscribe message failure. Realtime connection is not setting.");
            return;
        }
        ...
        if (this._client.connection.sendEvent(this._data.roomId, "message", "bind")) {
            ...
            var self_1 = this;
            setTimeout(function () {
                self_1.subscribeMessage(onMessageReceived);
            }, 3000);
        }
    };
    ...
    Room.prototype.subscribeUserJoin = function (onUserJoined) {
        ...
        if (!this._client.connection) {
            _1.logger("realtime", "error", "Subscribe userJoin failure. Realtime connection is not setting.");
            return;
        }
        ...
        if (this._client.connection.sendEvent(this._data.roomId, "userJoin", "bind")) {
            ...
            var self_3 = this;
            setTimeout(function () {
                self_3.subscribeUserJoin(onUserJoined);
            }, 3000);
        }
    };
    ...
    Room.prototype.subscribeUserLeft = function (onUserLeft) {
        ...
        if (this._client.connection.sendEvent(this._data.roomId, "userLeft", "bind")) {
            ...
            var self_4 = this;
            setTimeout(function () {
                self_4.subscribeUserLeft(onUserLeft);
            }, 3000);
        }
    };
