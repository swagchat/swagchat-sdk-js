...
var Realtime = (function () {
    function Realtime(endpoint) {
        var _this = this;
        console.info("%c[SwagChat]Connecting Realtime Server...", "color:" + const_2.realtimeLogColor);
        var websocket = const_1.isBrowser ? WebSocket : require("ws");
        this.conn = new websocket(endpoint);
        this.conn.addEventListener("open", function (e) {
            console.info("%c[SwagChat]Connecting Realtime Server OK", "color:" + const_2.realtimeLogColor);
