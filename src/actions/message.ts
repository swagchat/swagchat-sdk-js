...
export const BEFORE_RETRIEVE_ROOM_MESSAGES_REQUEST = 'BEFORE_RETRIEVE_ROOM_MESSAGES_REQUEST'; // deprecated
...
export const PUSH_LOCAL_MESSAGE = 'PUSH_LOCAL_MESSAGE'; // deprecated
export const SYNC_LOCAL_MESSAGES = 'SYNC_LOCAL_MESSAGES'; // deprecated
